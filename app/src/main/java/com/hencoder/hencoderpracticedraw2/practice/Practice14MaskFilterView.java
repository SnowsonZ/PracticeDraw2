...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    BlurMaskFilter bmfn = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
    BlurMaskFilter bmfi = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    BlurMaskFilter bmfo = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    BlurMaskFilter bmfs = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
